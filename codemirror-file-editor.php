...
function cmfe_admin_enqueue_scripts( $hook ) {
	...
	wp_register_style( 'codemirror', plugins_url( 'codemirror/lib/codemirror.css', __FILE__ ), null, '5.6.0' );
	...
	wp_register_script( 'cmfe', plugins_url( 'plugin.js', __FILE__ ), array( 'requirejs' ), '1.1.1', true );
